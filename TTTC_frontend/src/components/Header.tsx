...
} from "@/services/modules/visitors.api";
        ...
        <div className="container mx-auto px-4 py-3 relative">
          <div className="flex items-center justify-between">
            ...
            >
              <img
                src={logo}
                alt="Tiny Todds Therapy Care - Care with Compassion"
            ...
            <nav className="hidden xl:flex items-center gap-3">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-44 bg-white shadow-lg rounded-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                  <Link
                    to="/gallery"
                    className="flex items-center gap-2 px-4 py-3 hover:bg-secondary rounded-t-xl"
                  >
                    <Images className="w-4 h-4" />
                    Gallery
                  </Link>
                  <Link
                    to="/videos"
                    className="flex items-center gap-2 px-4 py-3 hover:bg-secondary rounded-b-xl"
                  >
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-52 bg-white shadow-lg rounded-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                  <Link
                    to="/contact"
                    className="flex items-center gap-2 px-4 py-3 hover:bg-secondary rounded-t-xl"
                  >
          ...
          <div className="fixed top-[23px] right-[58px] sm:top-[30px] sm:right-[30px] md:top-[24px] md:right-[65px] lg:top-[25px] lg:right-[15px] xl:top-[70px] xl:right-[16px] min-[1500px]:right-[calc((100vw-1536px)/2+50px)] 2xl:right-[calc((100vw-1536px)/2+80px)] z-[23] flex items-center">
            <div className="relative bg-success text-white text-[11px] md:text-xs font-semibold px-2 py-1 md:px-3 md:py-2 rounded-l-full shadow">
              ...
              <div
                className="absolute right-[-7px] md:right-[-11px] top-1/2 -translate-y-1/2 w-0 h-0
            ...
            <div className="bg-white/90 backdrop-blur-md border border-success/80 shadow-lg rounded-r-full px-2 py-[0px] md:px-4 md:py-[3px]">
              <span className="text-[14px] md:text-sm font-bold text-success">
                {visitors ?? "--"}
              </span>
            </div>
          </div>
